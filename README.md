...
result = hpsv2.score(imgs_path, '<prompt>', hps_version="v2.0") 
```

**Note**: Comparison is only meaningful for images generated by the **same prompt**. You can also pass "v2.1" to hps_version to use our updated model. Scores can not be directly compared between v2.0 and v2.1.
