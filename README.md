...
## Overview 
**Human Preference Dataset v2 (HPD v2)**: a large-scale (798k preference choices / 430k images), well-annotated dataset of human preference choices on images generated by text-to-image generative models. 
...
| Model                 | Animation | Concept-art | Painting | Photo    | DrawBench |
| ---------------------| --------- | ----------- | -------- | -------- | --------- |
...
The inference parameters and instructions are also provided in our paper, so you can also reproduce the table from your own images. 
...
Run the following command to evaluate the HPS v2 model on HPD v2 test set and ImageReward test set:
```shell
